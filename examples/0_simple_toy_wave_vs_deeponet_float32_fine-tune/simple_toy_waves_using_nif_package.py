...
class LossAndErrorPrintingCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % checkpt_epoch == 0:
            ...
            self.model.save_weights("./ckpt-{}/ckpt".format(epoch))
...
# model.save('./test') ## it doesn't work for graph with tf.einsum


# model_pnet.save("./latent_model_100")
# latent_to_p_model.save("./latent_to_p_100")
...
#           use_multiprocessing=True)
#
# model_pnet.save("./latent_model_500")
# latent_to_p_model.save("./latent_to_p_500")

# ref: https://github.com/Rishit-dagli/Gradient-Centralization-
# TensorFlow/blob/6fbb2e3f049665724a3cc87b7c9dde07830da6f1/gctf/centralized_gradients.py#L55
...
def get_centralized_gradients(optimizer, loss, params):
    ...
    This function is ideally not meant to be used directly unless you
    are building a custom optimizer, in which case you could point
    `get_gradients` to this function. This is a modified version of
    ...
    # We here just provide a modified get_gradients() function
    # since we are trying to just compute the centralized
